...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BATTERY_NO_MAPPING, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_PLUTO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_PLUTO_NRF52833, 1);
